# CSS and JS minify Sublime Text Plugin
...
Inglês :
    ...
    Since this is my frist job is it possible to have bugs,... please feel free to comment on issues area so that i can fix the problem or your self :)
